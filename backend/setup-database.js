...
const connection = mysql.createConnection({
    ...
    multipleStatements: true // Allows running all the DROP, CREATE, and INSERT commands at once
});
...
CREATE TABLE documents (
    ...
    uploaded_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- Using TIMESTAMP for maximum compatibility
